...
const loadFromUser = () => {
    ...
    if (!current) return;
    const fromMeta = (current.user_metadata as Record<string, any> | undefined)
        ?.full_name;
...
const handleSignOut = async () => {
    ...
    try {
        ...
        errorMessage.value = err?.message || "Failed to sign out";
    }
};
</script>
    ...
    <div class="settings-container">
        <div class="settings-header">
            ...
            <div class="header-actions">
                ...
                <button class="btn danger" type="button" @click="handleSignOut">
                    Sign Out
                </button>
            </div>
        </div>
